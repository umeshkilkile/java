...
public class PrimitiveOverloading_Demo {
	void f1(char x) {
	...
	public static void main(String[] args) {
		PrimitiveOverloading_Demo p = new PrimitiveOverloading_Demo();
		p.testConstVal();
		p.testChar();
		p.testByte();
		p.testShort();
 ...
 * method, that data type is promoted. char produces a slightly different
