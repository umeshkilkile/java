...
public class Demotion_Demo {
	...
	public static void main(String[] args) {
		Demotion_Demo p = new Demotion_Demo();
		p.testDouble();
	}
}
/*
 * Here, the methods take narrower primitive values. If your argument is wider,
 * then you must perform a narrowing conversion with a cast. If you don’t do
