...
public class SET_Iterate_Set_With_Custom_Objects_Demo {
	public static void main(String[] args) {
		...
		for(Iterator<Employee> empIterator1 = employeeHashSet.iterator(); empIterator1.hasNext();){
		...
		for(Iterator<Employee> empIterator1 = employeeTreeSet.iterator(); empIterator1.hasNext();){
			System.out.println(empIterator1.next());
		}
		/*
