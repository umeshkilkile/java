...
public class FinalData_Demo {
	private static Random rand = new Random(47);
	private String id;

	public FinalData_Demo(String id) {
		this.id = id;
	}
	...
	public static void main(String[] args) {
		FinalData_Demo fd1 = new FinalData_Demo("fd1");
		...
		FinalData_Demo fd2 = new FinalData_Demo("fd2");
		System.out.println(fd1);
 ...
 * expressed with the final keyword. A value must be given at the time of
 ...
 * meaning can be confusing. With a primitive, final makes the value a constant,
 * but with an object reference, final makes the reference a constant. Once the
