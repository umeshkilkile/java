...
public class Staff_Demo extends ArrayList<Position> {
	...
	public Staff_Demo(String... titles) {
		add(titles);
	}
	...
	public static void main(String[] args) {
		Staff_Demo staff = new Staff_Demo("President", "CTO", "Marketing Manager", "Product Manager", "Project Lead",
