...
public class TestEmployee_2 {
	public static void main(String[] args) {
		...
		List<Employee_2> listEmployee = new ArrayList<Employee_2>();
		
		listEmployee.add(new Employee_2("Umesh","Kilkile", new Date()));
		 ...
		 * 
		 * final Comparator<Employee> EMP_LAST_NAME_ASCENDING = new
		 * Comparator<Employee>() { public int compare(Employee emp1, Employee
		 * emp2){ return emp1.getLastName().compareTo(emp2.getLastName()); } };
		 * 
		 * final Comparator<Employee> EMP_LAST_NAME_DESCENDNG = new
		 * Comparator<Employee>() { public int compare(Employee emp1, Employee
		 * emp2){ return emp2.getLastName().compareTo(emp1.getLastName()); } };
		 * 
		 * 
