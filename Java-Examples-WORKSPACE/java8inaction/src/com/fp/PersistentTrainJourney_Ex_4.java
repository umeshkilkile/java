...
public class PersistentTrainJourney_Ex_4 {
	...
	/*
	 * This code is clearly functional style (it uses no mutation at all, even
	 * locally) and doesn’t modify any existing data structures.
	 */
