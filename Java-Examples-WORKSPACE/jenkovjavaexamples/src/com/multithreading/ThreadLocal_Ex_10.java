...
public class ThreadLocal_Ex_10 {
 ...
 * 
 * - However, since it is a ThreadLocal object then the two threads cannot see
 * each other's values. Thus, they set and get different values.
 */